...
/**
 * 此插件完成以下三件事：
 * 1、动态根据task决定gradle应用application还是library
 * 2、在1的基础上动态的设置src、manifest等的路径
 * 3、根据gradle.properties中配置的模块名添加依赖
 *
 * @author hua
 * @version 2018/3/30 10:46
 */
...
public class ComBuild implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        System.out.println("-----------handle " + module+" build.gradle start!!!----------")
        ...
        System.out.println("-----------handle " + module+" build.gradle end!!!----------")
